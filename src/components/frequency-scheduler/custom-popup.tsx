...
import './bootstrap.css'; // this lib uses boostrap (v. 4.0.0-beta.2)
import './styles.css'; // react-rrule-generator's custom CSS
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
//@ts-ignore
import RRuleGenerator from './lib/index';
      ...
      case 'WEEKLY':
        ...
        if (
          ...
          for (let i = 0; i < arrByDayRRule.length; i += 1) {
            const indexOfDayOfWeek = C_DAYS_OF_WEEK_RRULE.indexOf(
              arrByDayRRule[i]
            );
