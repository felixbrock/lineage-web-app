...
//   console.log("Response",response);
  ...
  var config = {
    method: 'post',
    url: 'https://slack.com/api/oauth.v2.access?client_id=3743837702852.3728367364791&client_secret=1fec399e9b4df09534572c709ad86fec&code=3334524827045.3793902891555.bfea9a43327dac26a309cf3148ce904caec850eee68ca1f2ed14a3afcdd5f2a9',
    headers: { 
      'Content-Type': 'application/x-www-form-urlencoded'
