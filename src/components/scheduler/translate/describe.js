...
export default (e) => {
    ...
    if (d) return {
        ...
        full: ("At " + d[1] + ":" + d[0] + " " + a + " " + s + " " + i + " " + u)
            .replace(/ +/g, " ")
            .trim() + "."
    };
    var m, f = p(o[0], "minute",
        {}, 59),
        h = "*" === (m = o[1]) ? "" : "past " + p(m, "hour",
            {}, 23);
    return {
        start: "At",
        minutes: f || null,
