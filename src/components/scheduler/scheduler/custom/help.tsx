  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      ...
      {wildcards.map((el, index) => (
        <div
          className="rounded-xl text-center font-bold border-2 border-gray-400 hover:border-cito"
      ...
      <div
        className={`col-span-3 h-28 break-normal rounded p-4 text-center italic border-2 border-cito`}
      >
        {explanation}
      </div>
    </div>
