...
const getOAuthEnvConfig = (): any => {
  ...
  switch (mode) {
    ...
    case 'demo':
      ...
      oAuthEnvConfig.redirectSignIn = 'https://demo-environment.d3pbv3guh4fc7o.amplifyapp.com';
      oAuthEnvConfig.redirectSignOut = 'https://demo-environment.d3pbv3guh4fc7o.amplifyapp.com';
      break;
    case 'production':
